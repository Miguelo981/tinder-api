...
import type { DescriptorFilterInput, GlobalModeLanguage, InterestInput } from '@/enums.ts';
...
export interface TinderUpdateProfileParams {
    ...
    globalMode?: {
        ...
        languagePreferences?: Array<{ language: GlobalModeLanguage; isSelected: boolean }>;
    };
}
...
export interface PreferenceFilters {
    ...
    preference_descriptors_filter?: Array<{ id: string; selected_choices: string[] }>;
